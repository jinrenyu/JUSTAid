 ...
 * @author c3400192
 */
public class PersonalMessageActivity extends AppCompatActivity implements
        OnClickListener {
       ...
       Button backButton=(Button) findViewById(R.id.back_button);
        backButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(PersonalMessageActivity.this, LoginActivity.class);
    ...
    public void init() {
        ...
        cImageView = (ImageView) findViewById(R.id.imageview_personal_photo);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageview_person_back:
                ...
                finish();
                break;
            case R.id.imageview_personal_photo:
